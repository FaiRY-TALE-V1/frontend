...
export const generateMockStory = (
  ...
  if (!selectedThemeData) {
    ...
    return {
        ...
        scenes: [
          {
            ...
            image_url:
              "https://via.placeholder.com/400x300/8B5CF6/FFFFFF?text=Scene+1",
            audio_url: "",
          ...
          },
          {
            ...
            image_url:
              "https://via.placeholder.com/400x300/EC4899/FFFFFF?text=Scene+2",
            audio_url: "",
          ...
          },
          {
            ...
            image_url:
              "https://via.placeholder.com/400x300/10B981/FFFFFF?text=Scene+4",
            audio_url: "",
      ...
      character_image_url:
        "https://via.placeholder.com/300x400/8B5CF6/FFFFFF?text=Character",
    };
  }
  ...
  return {
    ...
    character_image_url: `https://via.placeholder.com/300x400/8B5CF6/FFFFFF?text=${encodeURIComponent(
      childName
    )}`,
  };
};
