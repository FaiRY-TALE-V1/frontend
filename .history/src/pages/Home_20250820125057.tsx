  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl font-bold leading-tight lg:text-7xl text-gray-800">
                우리 아이만의
                <br />
            ...
            <div className="relative">
              <div className="relative z-10 p-8 transition-transform duration-500 transform bg-white shadow-2xl rounded-3xl rotate-3 hover:rotate-0">
                <div className="aspect-[4/5] bg-gradient-to-br from-orange-100 to-yellow-100 rounded-2xl p-6 flex flex-col items-center justify-center">
        ...
        <div className="absolute rounded-full top-20 right-20 w-72 h-72 bg-gradient-to-r from-green-300/20 to-emerald-300/20 blur-3xl"></div>
            ...
            {[
              ...
              <div key={index} className="text-center relative">
                <div className="relative mb-8">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto text-3xl bg-gradient-to-r from-green-100 to-emerald-100 rounded-full shadow-lg">
                    {step.icon}
                  </div>
                  <div className="absolute flex items-center justify-center w-8 h-8 text-sm font-bold text-white rounded-full -top-2 -right-2 bg-gradient-to-r from-green-600 to-emerald-600">
                    {step.step}
                  </div>
                </div>
                ...
                {index < 2 && (
                  <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-green-200 to-emerald-200 transform translate-x-1/2">
                    <div className="absolute top-0 left-1/2 w-2 h-2 bg-green-300 rounded-full transform -translate-x-1/2"></div>
                    <div className="absolute top-0 left-1/4 w-1 h-1 bg-yellow-300 rounded-full"></div>
                    <div className="absolute top-0 right-1/4 w-1 h-1 bg-blue-300 rounded-full"></div>
                  </div>
                )}
              </div>
            ))}
