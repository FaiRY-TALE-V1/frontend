            ...
            <div className="relative">
              <div className="relative z-10 flex items-end justify-center">
                <img
                  ...
                  className="object-contain w-[1200px] h-[1200px] drop-shadow-2xl"
                />
              </div>

              <div className="absolute w-[820px] h-[820px] -top-10 -left-10 bg-gradient-to-br from-green-200 to-emerald-200 rounded-3xl -z-10"></div>
              <div className="absolute w-[820px] h-[820px] -bottom-10 -right-10 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-3xl -z-20"></div>
            </div>
          </div>
        </div>
