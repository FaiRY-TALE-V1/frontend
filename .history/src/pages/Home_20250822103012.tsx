          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl font-bold leading-tight tracking-tight text-gray-900 lg:text-6xl">
                우리 아이만의
                <br />
                <span className="relative text-transparent bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 bg-clip-text animate-pulse">
                  <span className="absolute inset-0 bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 blur-sm opacity-75 animate-pulse"></span>
                  마법같은 동화책
                </span>
              </h1>
