        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative">
              ...
              <div className="absolute w-[620px] h-[620px] -top-8 -left-8 bg-gradient-to-br from-green-200 to-emerald-200 rounded-3xl -z-10"></div>
              <div className="absolute w-[620px] h-[620px] -bottom-8 -right-8 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-3xl -z-20"></div>
            </div>
          </div>
        </div>
