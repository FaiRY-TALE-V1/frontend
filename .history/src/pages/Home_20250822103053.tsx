          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <button
                  onClick={handleStartClick}
                  className="flex items-center justify-center px-8 py-4 text-base font-medium text-white transition-all duration-300 rounded-xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 group hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105"
                >
                  동화 만들기 시작
