  ...
  const themes: Theme[] = [
    {
      ...
      moral: "진정한 친구는 어려울 때 서로 도와주는 사람이에요. 함께 하면 혼자서는 할 수 없는 일도 해낼 수 있답니다.",
      exampleImages: [
        "🏰", "🌈", "🦄"
      ]
    },
    {
      ...
      moral: "무서운 일이 생겨도 용기를 내어 한 걸음씩 나아가면 할 수 있어요. 포기하지 않는 마음이 가장 중요해요.",
      exampleImages: [
        "🏔️", "⚔️", "🦸"
      ]
    },
    {
      ...
      moral: "작은 친절도 상대방에게는 큰 기쁨이 될 수 있어요. 서로 도우며 사는 세상이 더 아름다워요.",
      exampleImages: [
        "🌸", "🐰", "🌟"
      ]
    },
    {
      ...
      moral: "거짓말은 더 큰 문제를 만들어요. 정직하게 말하면 때로는 혼날 수 있지만, 믿음을 얻을 수 있어요.",
      exampleImages: [
        "🏆", "🌞", "📚"
      ]
    },
    {
      ...
      moral: "처음에는 어려워도 계속 연습하면 잘할 수 있게 돼요. 포기하지 않는 마음이 성공의 비결이에요.",
      exampleImages: [
        "🏃", "🎪", "🎨"
      ]
    },
    {
      ...
      moral: "나눌수록 행복은 더 커져요. 혼자 가지는 것보다 함께 나누는 것이 더 즐거워요.",
      exampleImages: [
        "🍰", "🎁", "🌺"
      ]
    },
    {
      ...
      moral: "모든 사람은 서로 달라요. 다른 점을 이해하고 존중하면 더 좋은 친구가 될 수 있어요.",
      exampleImages: [
        "🌍", "🎭", "🤝"
      ]
    },
    {
      ...
      moral: "약속은 꼭 지켜야 해요. 작은 책임부터 잘 지키면 더 큰 일도 믿고 맡길 수 있어요.",
      exampleImages: [
        "⏰", "📝", "🏠"
      ]
    },
    {
      ...
      moral: "상상하는 모든 것은 가능해요. 자유롭게 생각하고 표현하면 놀라운 일들이 일어날 수 있어요.",
      exampleImages: [
        "🎪", "🎨", "✨"
      ]
    },
    {
      ...
      moral: "우리 주변에는 고마운 것들이 많아요. 작은 것에도 감사하는 마음을 가지면 더 행복해져요.",
      exampleImages: [
        "🌱", "☀️", "🏡"
      ]
    }
