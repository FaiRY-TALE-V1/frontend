  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 overflow-hidden bg-white">
        ...
        <div className="absolute z-0 top-32 left-20 opacity-30">
          <img
            src="/sun.svg"
            alt="sun"
            className="w-16 h-16"
        ...
        <div className="absolute z-0 opacity-25 top-80 right-24">
          <img
            src="/circle.svg"
            alt="circle"
            className="w-12 h-12"
        ...
        <div className="absolute z-0 bottom-32 left-32 opacity-20">
          <img
            src="/star.svg"
            alt="star"
            className="w-14 h-14"
        ...
        <div className="absolute z-0 top-96 right-40 opacity-30">
          <img
            src="/spark.svg"
            alt="spark"
            className="w-10 h-10"
