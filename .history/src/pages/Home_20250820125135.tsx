            ...
            {[
              ...
              <div key={index} className="text-center relative group">
                <div className="relative mb-8">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto text-3xl bg-gradient-to-r from-green-100 to-emerald-100 rounded-full shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl">
                    {step.icon}
                  </div>
                  <div className="absolute flex items-center justify-center w-8 h-8 text-sm font-bold text-white rounded-full -top-2 -right-2 bg-gradient-to-r from-green-600 to-emerald-600 shadow-lg">
                    {step.step}
                  </div>
                </div>
                ...
                {index < 2 && (
                  <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-green-200 to-emerald-200 transform translate-x-1/2">
                    <div className="absolute top-0 left-1/2 w-2 h-2 bg-green-300 rounded-full transform -translate-x-1/2 animate-pulse"></div>
                    <div className="absolute top-0 left-1/4 w-1 h-1 bg-yellow-300 rounded-full animate-bounce"></div>
                    <div className="absolute top-0 right-1/4 w-1 h-1 bg-blue-300 rounded-full animate-pulse"></div>
                  </div>
                )}
              </div>
            ))}
