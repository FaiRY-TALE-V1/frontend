...
import { ChevronLeft, ChevronRight, Home, Volume2, VolumeX, Loader2 } from "lucide-react";
  ...
  useEffect(() => {
    const generateStory = async () => {
      try {
        ...
        // API 호출하여 스토리 생성
        const generatedStory = await apiService.generateCompleteStory(storyRequest);
