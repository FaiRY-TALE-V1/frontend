          ...
          <div className="grid gap-12 lg:grid-cols-3">
            {[
              ...
              <div key={index} className="relative group">
                <div className="flex flex-col items-center p-8 text-center transition-all duration-300 border border-gray-200 shadow-lg rounded-2xl bg-white hover:shadow-xl hover:-translate-y-2 hover:border-emerald-200">
                  {/* Step Number */}
                  ...
                  {/* Content */}
                  <h3
                    className={`mb-4 text-2xl font-bold text-gray-900 transition-colors duration-300 ${
                      index === 0
                  ...
                  <p className="max-w-sm text-base leading-relaxed text-gray-700 font-medium">
                    {step.description}
                  </p>
                </div>
