    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Star SVG Elements */}
          <div className="absolute opacity-25 top-1/4 right-1/4">
            <img
              src="/star.svg"
              alt=""
          ...
          <div className="absolute opacity-25 bottom-1/4 left-1/3">
            <img
              src="/spark.svg"
              alt=""
              className="w-4 h-4 animate-pulse"
      ...
      {/* Footer */}
      <footer className="relative py-16 overflow-hidden bg-gray-900">
        {/* Background SVG Elements */}
        <div className="absolute inset-0 pointer-events-none">
