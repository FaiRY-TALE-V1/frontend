          ...
          <div className="grid gap-12 lg:grid-cols-3">
            {[
              ...
              <div key={index} className="relative group">
                <div className="flex flex-col items-center p-8 text-center transition-all duration-300 border border-gray-400 shadow-sm rounded-2xl bg-gradient-to-br from-white to-gray-50 hover:shadow-lg hover:-translate-y-1">
                  {/* Step Number */}
