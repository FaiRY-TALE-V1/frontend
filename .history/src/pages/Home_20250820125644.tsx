            ...
            <div className="relative">
              <div className="relative z-10 flex items-center justify-center">
                <img
                  ...
                  className="object-contain w-[500px] h-[500px] drop-shadow-2xl"
                />
              </div>

              <div className="absolute w-[520px] h-[520px] -top-6 -left-6 bg-gradient-to-br from-green-200 to-emerald-200 rounded-3xl -z-10"></div>
              <div className="absolute w-[520px] h-[520px] -bottom-6 -right-6 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-3xl -z-20"></div>
            </div>
          </div>
        </div>
