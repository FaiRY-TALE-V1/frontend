            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <button
                  ...
                  className="flex items-center justify-center px-6 py-3 text-base font-semibold text-gray-700 transition-all duration-300 border-2 border-gray-300 rounded-2xl hover:border-purple-300 hover:text-purple-600"
                >
          ...
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
            {[
              ...
              <div key={index} className="text-center">
                <div className="mb-2 text-3xl font-bold text-transparent lg:text-4xl bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text">
                  {stat.number}
                </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-600">
              첨단 AI 기술과 교육학적 전문성이 만나 만들어내는 완벽한 개인화
              동화 경험
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {features.map((feature, index) => (
              <div key={index} className="relative group">
                ...
                ></div>
                <div className="relative p-8 transition-all duration-500 transform bg-white shadow-lg rounded-3xl hover:shadow-2xl hover:-translate-y-2">
                  <div
                  ...
                  <div className="flex items-center mt-6 font-medium text-purple-600 transition-transform duration-300 group-hover:translate-x-2">
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                title: "AI가 창작",
                description:
                  "첨단 AI가 아이만을 위한 특별한 이야기를 만들어냅니다",
                icon: "🤖",
              },
              {
                step: "03",
              ...
              <div key={index} className="text-center">
                <div className="relative mb-8">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto text-3xl bg-white rounded-full shadow-lg">
                    {step.icon}
                  </div>
                  <div className="absolute flex items-center justify-center w-8 h-8 text-sm font-bold text-white rounded-full -top-2 -right-2 bg-gradient-to-r from-purple-600 to-pink-600">
                    {step.step}
                  </div>
                </div>
                <h3 className="mb-4 text-2xl font-bold text-gray-900">
