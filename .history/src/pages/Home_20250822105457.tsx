  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="absolute opacity-55 top-32 right-32">
          <img
            src="/sun.svg"
            alt="sun"
            className="w-10 h-10"
        ...
        <div className="absolute opacity-50 bottom-40 left-20">
          <img
            src="/circle.svg"
            alt="circle"
            className="w-6 h-6"
        ...
        <div className="absolute opacity-55 top-1/3 left-32">
          <img
            src="/spark.svg"
            alt="spark"
            className="w-10 h-10"
      ...
      <section className="relative py-20 overflow-hidden bg-white">
        ...
        <div className="absolute top-10 right-20 opacity-55">
          <img
            src="/star.svg"
            alt="star"
            className="w-6 h-6"
        ...
        <div className="absolute opacity-50 bottom-20 left-10">
          <img
            src="/spark.svg"
            alt="spark"
            className="w-8 h-8"
        ...
        <div className="absolute z-0 top-32 left-20 opacity-65">
          <img
            src="/sun.svg"
            alt="sun"
            className="w-16 h-16"
        ...
        <div className="absolute z-0 opacity-60 top-80 right-24">
          <img
            src="/circle.svg"
            alt="circle"
            className="w-12 h-12"
        ...
        <div className="absolute z-0 bottom-32 left-32 opacity-55">
          <img
            src="/star.svg"
            alt="star"
            className="w-14 h-14"
        ...
        <div className="absolute z-0 top-96 right-40 opacity-65">
          <img
            src="/spark.svg"
            alt="spark"
            className="w-10 h-10"
