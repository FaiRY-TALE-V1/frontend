    ...
    <div className="min-h-screen p-4 bg-gradient-to-br from-primary-50 via-secondary-50 to-purple-50">
      ...
      >
        ...
        <motion.div
          ...
          className="p-8 space-y-8 bg-white shadow-lg rounded-xl"
        >
          {/* 아이 이름 */}
          ...
          {/* 성별 선택 */}
          <div className="space-y-3">
            <label className="text-lg font-medium text-gray-800">성별 *</label>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              아이의 특징을 담은 사진을 업로드하면 더욱 닮은 캐릭터로 동화를
              만들어드려요 (최대 5장)
            </p>
                ...
                {previewImages.map((image, index) => (
                  ...
                  >
                    <img
                      src={image}
                      alt={`Preview ${index + 1}`}
                      className="object-cover w-full h-24 border-2 border-gray-200 rounded-lg"
                    />
                    <button
            ...
            <div className="relative">
              ...
              <label
                ...
                className="flex flex-col items-center justify-center p-8 text-center transition-colors duration-200 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100"
              >
                <Upload className="w-8 h-8 mb-3 text-gray-400" />
                <p className="font-medium text-gray-600">사진 선택하기</p>
